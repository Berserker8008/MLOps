...
class CIFAR10DataManager:
    """Manages CIFAR-10 data loading, preprocessing, and splitting."""
...
# Legacy compatibility - keep MNIST classes for backward compatibility
...
class DataManager:
    """Manages data loading, preprocessing, and splitting. Legacy MNIST support."""
